        ...
        <div className="grid grid-cols-12 bg-slate-100">
            ...
            <section className="grid col-span-10 bg-slate-100 overflow-auto h-screen relative">
                <div className="relative flex justify-center mt-10">
                    <input
                        className="relative appearance-none pl-10 border-gray-300 hover:border-gray-400 transition-colors rounded-full w-[87%] h-16 py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:ring-purple-600 focus:border-purple-600 focus:shadow-outline"
                        id="username"
                        type="text"
                ...
                <div className="bg-white h-screen w-[87%] rounded-3xl p-10 mt-9 m-auto overflow-auto"> 
                    <Button className="rounded-full bg-[#F5F7F8] text-[20px] text-[#087E8B] h-16 w-44">HomePage</Button>
