    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center w-full h-screen overflow-hidden text-gray-700 bg-white rounded">
                ...
                <span className="ml-2 text-sm font-bold text-center flex justify-center py-2 text-[20px] text-[#0B3954]">Moeurn Sovanara</span>
                <p className="text-[#087E8B] py-1 text-[20px]">pozzliik1280@gmail.com</p>
                </div>
                ...
                <div className="flex flex-col items-center w-full mt-2">
                    ...
                    <span className="ml-2 text-[20px] font-medium">Book Categories</span>
                    </Link>

                    <Link href="/cartoon-category"
                    className="flex items-center w-full h-12 px-3 mt-2  hover:bg-gray-300"
                    >
                    <Image src={school_cartoon}/>
                    <span className="ml-2 text-[20px] font-medium">Old-School Cartoons</span>
                    </Link>
                    ...
                    >
                    <Image src={video}/>
                    <span className="ml-2 text-[20px] font-medium">Movies & TV Shows</span>
                    </a>
                    ...
                    <a
                        ...
                        >
                        <Image src={weight}/>
                        <span className="ml-2 text-[20px] font-medium">Sports & Fitness</span>
                    </a>
                    ...
                    <a
                        ...
                        >
                        <Image src={code}/>
                        <span className="ml-2 text-[20px] font-medium">Technology & GadGets</span>
                    </a>
                    ...
                    <a
                        ...
                        >
                        <Image src={airplane}/>
                        <span className="ml-2 text-[20px] font-medium">Travel & Exploration</span>
                    </a>
                    <a
                        className="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300"
                        href="#"
                        >
                        <Image src={edit}/>
                        <span className="ml-2 text-[20px] font-medium">Writing & Journaling</span>
                    </a>
                </div>
                </div>
            ...
            <div className="group fixed bottom-0 right-0 p-2  flex items-end justify-end w-24 h-24 ">
                ...
                {/* sub left */}
                <a
                href="https://instagram.com/akashgandhar0"
                target="_blank"
                ...
                {/* sub top */}
                <a
                href="https://github.com/akashgandhar"
                target="_blank"
